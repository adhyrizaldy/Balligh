    ...
    private void sendData(final String jenisAkun) {
        ...
        database.child("users")
                ...
                .addOnCompleteListener(new OnCompleteListener<Void>() {
                    ...
                    public void onComplete(@NonNull Task<Void> task) {
                        if (task.isSuccessful()) {
                            ...
                            Toast.makeText(ActMainMasjid.this, getResources().getString(R.string.succes_swithc), Toast.LENGTH_SHORT).show();
                            startActivity(new Intent(ActMainMasjid.this, ActSplashScreen.class));
                            finish();
                        } else {
                            progressDialog.dismiss();
            ...
            public void onFailure(@NonNull Exception e) {
                progressDialog.dismiss();
                Toast.makeText(ActMainMasjid.this, e.getMessage().toString(), Toast.LENGTH_SHORT).show();
            }
        });
    }
