...
public class ActEditProfilLembaga extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.act_edit_profil_lembaga);
        ...
        adapterKategori.AddFragment(new fragProfilLembaga());
        adapterKategori.AddFragment(new fragProfilLembaga());
        adapterKategori.AddFragment(new fragProfilLembaga());
        ...
        tabKategori.getTabAt(0).setText(getResources().getString(R.string.text_frag_lembaga));
        tabKategori.getTabAt(1).setText(getResources().getString(R.string.text_frag_masjid));
        tabKategori.getTabAt(2).setText(getResources().getString(R.string.text_frag_muballigh));

        btnBack.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                fragBioMuballigh.nama = "";
                startActivity(new Intent(ActEditProfilLembaga.this, ActProfilLembaga.class));
                finish();
            }
        });
    }
